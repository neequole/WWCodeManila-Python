...
Just some notes:
* Please use this [template](https://github.com/wwcodemanila/WWCodeManila-Python/blob/master/basic_concepts/exercises/exercises02/exercises02.py) to be able to print the reward.
