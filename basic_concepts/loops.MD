...
Just some notes:
* Please use and copy [loops01.py](https://github.com/wwcodemanila/WWCodeManila-Python/blob/master/basic_concepts/exercises/loops/loops01.py) as your template.
