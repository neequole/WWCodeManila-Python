...
Just some notes:
* You can use and copy [exercise01.py](https://github.com/wwcodemanila/WWCodeManila-Python/blob/master/basic_concepts/exercises/exercises01/exercises01.py) as template.
