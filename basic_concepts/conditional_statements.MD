...
Just some notes:
* Please see use and copy this [template](https://github.com/wwcodemanila/WWCodeManila-Python/blob/master/basic_concepts/exercises/conditional_statements/conditional01.py):
